...
let test = async function() {
  ...
  // let expression = "(1+1)*2-(1+5)/2+2^3+3!";//==15
  //post Expression [1,1,+,2,*,1,5,+,2,/,-,2,3,^,+,3,!,+]
  // let expression = "2*2-6/2";

  let expression = "2+3*2-1";

  console.log(Calculator.verify(expression));

  let list = Calculator.midExpression(expression);
  let list2 = Calculator.postExpression(list);

  console.log(list2);

  let s = Calculator.math(list2);
