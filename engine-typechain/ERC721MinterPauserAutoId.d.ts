...
interface ERC721MinterPauserAutoIdInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721MinterPauserAutoId extends BaseContract {
  ...
  interface: ERC721MinterPauserAutoIdInterface;
