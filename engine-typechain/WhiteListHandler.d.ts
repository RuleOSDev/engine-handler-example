...
interface WhiteListHandlerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "ruleConfig(bytes32)": FunctionFragment;
    "ruleWhiteAddressList(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ruleConfig",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
    functionFragment: "ruleWhiteAddressList",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "ruleConfig", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "ruleWhiteAddressList",
    data: BytesLike
  ): Result;
  ...
  events: {
    "EventWhiteList(address,uint32,uint16,uint16,address,uint8)": EventFragment;
    "Initialized(uint8)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "EventWhiteList"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Initialized"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
}

export type EventWhiteListEvent = TypedEvent<
...
export class WhiteListHandler extends BaseContract {
  ...
  interface: WhiteListHandlerInterface;
  ...
  ruleConfig(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    "EventWhiteList(address,uint32,uint16,uint16,address,uint8)"(
