...
interface PoolTokenInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "Approval(address,uint256,address,uint256,uint256)": EventFragment;
    "ApproveForAll(address,uint256,address,bool)": EventFragment;
    ...
    "Transfer(address,uint256,uint16,address,uint256,uint256)": EventFragment;
    "TransferBatch(address,uint256,uint16[],address,uint256[],uint256[])": EventFragment;
...
export class PoolToken extends BaseContract {
  ...
  filters: {
    ...
    "Approval(address,uint256,address,uint256,uint256)"(
      token?: string | null,
      erc?: null,
      spender?: string | null,
      tokenId?: null,
    ...
    "ApproveForAll(address,uint256,address,bool)"(
      token?: string | null,
      erc?: null,
      spender?: string | null,
      approved?: null
      ...
      [string, BigNumber, string, boolean],
      { token: string; erc: BigNumber; spender: string; approved: boolean }
    >;
    ...
    "Transfer(address,uint256,uint16,address,uint256,uint256)"(
      token?: string | null,
      erc?: null,
      allocationId?: null,
      to?: string | null,
    ...
    "TransferBatch(address,uint256,uint16[],address,uint256[],uint256[])"(
      token?: string | null,
      erc?: null,
      allocationIds?: null,
      to?: string | null,
