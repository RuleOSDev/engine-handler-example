...
interface RandomHashInterface extends ethers.utils.Interface {
  functions: {
    "blockHashTask(bytes32)": FunctionFragment;
    "checkRandom(address,address,uint32,uint16,uint16,address,uint32,address)": FunctionFragment;
...
export class RandomHash extends BaseContract {
